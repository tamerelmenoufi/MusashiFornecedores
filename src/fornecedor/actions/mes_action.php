<?php
    ...
    if($verify->rowCount() == 0){
        ...
        $medias = $pdo->prepare("SELECT AVG(eficiencia) as eficiencia, AVG(100 - total_demerito_delivery) as delivery, AVG(100 - total_demerito_quality) as quality, (AVG(eficiencia) + AVG(100 - total_demerito_delivery) + AVG(100 - total_demerito_quality))/3 as classificacao FROM registros_diarios 
