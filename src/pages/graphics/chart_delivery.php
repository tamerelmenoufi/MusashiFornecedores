    ...
    for($i=11; $i>=0; $i--){
        ...
        if($query->rowCount() > 0){
            ...
            foreach($fornecedor as $ind => $valor){
                ...
                if($array_valores1[$ind] <= 91.99){
                    $array_cor1[$ind] = '"#dc3545"'; /// DEFICIENTE
                    $array_border1[$ind] = '"#dc3545"';
                }elseif($array_valores1[$ind] >= 92.00 && $array_valores1[$ind] <= 95.99){///// REGULAR
                    $array_cor1[$ind] = '"#ffc107"';
                    $array_border1[$ind] = '"#ffc107"';
                }elseif($array_valores1[$ind] >= 96.00 && $array_valores1[$ind] <= 98.99){ //// BOM
